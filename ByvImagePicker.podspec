...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ByvImagePicker.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/ByvImagePicker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Adrian Apodaca macbook air' => 'adrian@byvapps.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/ByvImagePicker.git', :tag => s.version.to_s }
